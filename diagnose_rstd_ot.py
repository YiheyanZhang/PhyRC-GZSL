...
from utils.config import class_id_lists, class_names_from_config, load_config, resolve_device, set_seed
...
def main():
    ...
    parser.add_argument("--attributes", default="data/processed/PaviaU_structured_attributes.json")
    ...
    ds = config["dataset"]
    raw_root = root / ds.get("raw_dir", "data/raw")
