...
from phyrc_gzsl.utils.config import class_names_from_config, load_config
...
def main() -> None:
    ...
    parser.add_argument("--output", default="phyrc_gzsl/checkpoints/paviau_sensor_aligned_conditions.pt")
