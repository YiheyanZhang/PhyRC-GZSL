...
from phyrc_gzsl.models.backbone import (
...
def main() -> None:
    ...
    parser.add_argument("--config", default="phyrc_gzsl/configs/paviau_spectral_mae.yaml")
    ...
    if backbone_name in ("spectral_morphology", "physics_invariant") and teacher_checkpoint:
        ...
        if not teacher_path.is_absolute():
            teacher_path = project_root / "phyrc_gzsl" / teacher_path
    ...
    if not checkpoint.is_absolute():
        checkpoint = project_root / "phyrc_gzsl" / checkpoint
