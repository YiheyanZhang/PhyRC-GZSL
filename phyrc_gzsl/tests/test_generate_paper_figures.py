...
class PaperFigureDataTests(unittest.TestCase):
    def test_loads_all_formal_loco_candidates_without_test_metrics(self):
        from phyrc_gzsl.generate_paper_figures import load_loco_tradeoff_data
    ...
    def test_reconstructs_exact_run_specific_feasibility(self):
        from phyrc_gzsl.generate_paper_figures import is_rcjd_feasible
    ...
    def test_writes_loco_tradeoff_pdf_and_png(self):
        from phyrc_gzsl.generate_paper_figures import write_loco_tradeoff_figure
    ...
    def test_loads_only_formal_risk_and_failure_evidence(self):
        from phyrc_gzsl.generate_paper_figures import load_failure_data, load_risk_data
    ...
    def test_writes_self_contained_svg_figures(self):
        from phyrc_gzsl.generate_paper_figures import (
            _failure_svg,
            _risk_svg,
            load_failure_data,
            load_risk_data,
