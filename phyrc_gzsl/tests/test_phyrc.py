...
class CFDCTests(unittest.TestCase):
    def test_ranked_centers_support_multiple_unseen_targets(self):
        from phyrc_gzsl.evaluate_p1 import predict_relation_variants
        from phyrc_gzsl.evaluate_phyrc import _predict_ranked_centers
    ...
    def test_backbone_partition_rejects_wrong_seen_classes(self):
        from phyrc_gzsl.evaluate_phyrc import _validate_backbone_partition

        with patch("phyrc_gzsl.evaluate_phyrc.torch.load", return_value={"seen_classes": [1, 2]}):
            with self.assertRaisesRegex(ValueError, "partition"):
                _validate_backbone_partition("backbone.pt", [1, 3])

    def test_physical_distribution_loco_scores_are_finite(self):
        from phyrc_gzsl.evaluate_p1 import build_loco_episodes
    ...
    def test_relational_prototype_attention_normalizes_each_head(self):
        from phyrc_gzsl.phyrc.attention import RelationalPrototypeAttention
    ...
    def test_gzsl_attention_decoder_starts_from_prototype_matching(self):
        from phyrc_gzsl.phyrc.attention import GZSLAttentionDecoder
    ...
    def test_prototype_set_scores_use_best_candidate_per_sample(self):
        from phyrc_gzsl.phyrc.attention import prototype_set_scores
    ...
    def test_relation_episode_weights_favor_matching_attribute(self):
        from phyrc_gzsl.evaluate_phyrc import _relation_episode_weights
    ...
    def test_binary_auroc_handles_ties_without_pairwise_matrix(self):
        from phyrc_gzsl.evaluate_phyrc import _binary_auroc
    ...
    def test_dual_pvalues_favor_the_matching_domain(self):
        from phyrc_gzsl.phyrc.calibration import dual_domain_pvalues, fit_dual_calibration
    ...
    def test_cross_fitted_scores_are_deterministic(self):
        from phyrc_gzsl.phyrc.calibration import cross_fit_domain_scores
    ...
    def test_calibration_strength_zero_recovers_raw_router(self):
        from phyrc_gzsl.phyrc.calibration import calibrated_domain_probability
    ...
    def test_candidate_selection_keeps_p1_when_no_feasible_gain(self):
        from phyrc_gzsl.phyrc.calibration import select_dual_candidate
...
class RCJDTests(unittest.TestCase):
    def test_class_mode_distribution_is_deterministic_and_normalized(self):
        from phyrc_gzsl.phyrc.attention import class_mode_distribution
    ...
    def test_transport_mode_distribution_normalizes_joint_weights(self):
        from phyrc_gzsl.phyrc.attention import transport_mode_distribution
    ...
    def test_collapsed_distribution_recovers_cosine_score(self):
        from phyrc_gzsl.phyrc.attention import prototype_distribution_scores
    ...
    def test_adaptive_decoder_preserves_clear_seen_and_rescues_unseen(self):
        from phyrc_gzsl.phyrc.decoder import adaptive_joint_scores
    ...
    def test_nested_learned_decoder_uses_domain_evidence(self):
        from phyrc_gzsl.phyrc.decoder import learn_nested_risk_parameters, learned_joint_scores
    ...
    def test_nested_learned_decoder_accepts_rcjd_reference(self):
        from phyrc_gzsl.phyrc.decoder import learn_nested_risk_parameters
    ...
    def test_zero_risk_weight_recovers_cosine_scores(self):
        from phyrc_gzsl.phyrc.decoder import joint_risk_scores
    ...
    def test_decoder_selection_enforces_stability_before_h(self):
        from phyrc_gzsl.phyrc.decoder import select_decoder_candidate
