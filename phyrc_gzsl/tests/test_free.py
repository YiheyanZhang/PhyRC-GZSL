...
from phyrc_gzsl.baseline.free import synthesize_features, train_free
from phyrc_gzsl.baseline.evaluate_free import (
    STRICT_FREE, evaluate_split, validate_strict_training_labels,
)
from phyrc_gzsl.baseline.run_free_strict_5seed import checkpoint_pattern
...
class FREETests(unittest.TestCase):
    ...
    def test_strict_checkpoint_pattern_matches_seed_layout(self):
        self.assertEqual(
            ...
            "phyrc_gzsl/checkpoints/paviau_p1_backbone_s{unseen}.pt",
        )
        self.assertEqual(
            checkpoint_pattern("paviau", 43),
            "phyrc_gzsl/checkpoints/multiseed/paviau/seed43/"
