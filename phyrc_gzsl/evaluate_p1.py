...
from phyrc_gzsl.diagnose_rstd_ot import (
...
def predict_prototype_set(
    ...
    from phyrc_gzsl.phyrc.attention import predict_attention_center
...
def hybrid_distribution_score_matrix(
    ...
    from phyrc_gzsl.phyrc.attention import prototype_distribution_scores, prototype_set_scores
...
def main() -> None:
    ...
    parser.add_argument(
        "--attributes", default="phyrc_gzsl/data/processed/PaviaU_structured_attributes.json",
    )
    parser.add_argument("--output", default="phyrc_gzsl/checkpoints/p1_final_gzsl.json")
    parser.add_argument("--unseen-classes", nargs="+", type=int)
    parser.add_argument(
        "--backbone-pattern", default="phyrc_gzsl/checkpoints/paviau_p1_backbone_s{unseen}.pt",
    )
